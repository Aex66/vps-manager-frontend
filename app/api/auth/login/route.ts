...
import { SESSION_MAX_AGE_SEC, VPS_SESSION_COOKIE } from "@/lib/auth-cookie"
...
export async function POST(req: Request) {
  ...
  const r = await fetch(`${backendBaseUrl()}/api/login`, {
    method: "POST",
  ...
  res.cookies.set(VPS_SESSION_COOKIE, token, {
    httpOnly: true,
